...
public class NotificatoreAcquisto implements MessageListener {
	...
	public void start() throws NamingException, JMSException {  // CONNECTION FACTORY --> CONNECTION -->SESSION --> MESSAGE PRODUCER --> PUBLISHER.SENDMESSAGE
	...
	public void onMessage(Message mex) {
		...
		boolean status = randomGen.nextFloat() < 0.5;
                System.out.println("ARRIVVATO MEX");
		try {
