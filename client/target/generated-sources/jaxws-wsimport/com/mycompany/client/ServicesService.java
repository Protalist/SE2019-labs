 ...
 * 
 */
@WebServiceClient(name = "ServicesService", targetNamespace = "http://ws_bank.mycompany.com/", wsdlLocation = "http://localhost:8081/Services?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICESSERVICE_QNAME = new QName("http://ws_bank.mycompany.com/", "ServicesService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/Services?wsdl");
    ...
    public ServicesInterface getServicesPort() {
        return super.getPort(new QName("http://ws_bank.mycompany.com/", "ServicesPort"), ServicesInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicesPort")
    public ServicesInterface getServicesPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws_bank.mycompany.com/", "ServicesPort"), ServicesInterface.class, features);
    }
